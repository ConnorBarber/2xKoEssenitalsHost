  ...
  tabs: [
      {
        ...
        moves: [
          { numericNotation: '5M', notation: '', notationImage: '/key-moves-notation/blitz/blitz1.png', description: 'Main Neutral Poke tool, disjointed enough to challenge with', video: 'videos/blitz/key-moves/blitz1.mp4' },
          { numericNotation: '2H', notation: '', notationImage: '/key-moves-notation/blitz/blitz2.png', description: 'Huge Anti Air', video: 'videos/blitz/key-moves/blitz2.mp4' },
          { numericNotation: '5L', notation: '', notationImage: '/key-moves-notation/blitz/blitz3.png', description: 'Fastest button at 7 frames. Key for punishes, mashing out, and stagger pressure', video: 'videos/blitz/key-moves/blitz3.mp4' },
          { numericNotation: 'S2', notation: '', notationImage: '/key-moves-notation/blitz/blitz4.png', description: 'Rocket Punch is useful for destroying projectiles, stopping jumps, and provides a wall bounce if it hits aerial targets', video: 'videos/blitz/key-moves/blitz4.mp4' },
          { numericNotation: 'S1 and j.S1', notation: '', notationImage: '/key-moves-notation/blitz/blitz5.png', description: 'Rocket Grab allows Blitz to yank enemies in close, and start his strike/throw mix.j.S1 is the air version of S1 and allows for Blitz to get a hit grab. In steam both options allow follow ups on hit.', video: 'videos/blitz/key-moves/blitz5.mp4' },   
          { numericNotation: '{S1}', notation: '', notationImage: '/key-moves-notation/blitz/blitz6.png', description: 'Holding S1 lets Blitz start cranking, and builld steam. Backdash to cancel out of this move, it makes it a great bait, as opponents will approach when they see you cranking.', video: 'videos/blitz/key-moves/blitz6.mp4' },   
          { numericNotation: '2S1', notation: '', notationImage: '/key-moves-notation/blitz/blitz7.png', description: 'This is the anti air version of the grab, allowing blitz to rip opponents out of the sky if unsafely jumping', video: 'videos/blitz/key-moves/blitz7.mp4' }, 
          { numericNotation: '2S2 and j.2S2', notation: '', notationImage: '/key-moves-notation/blitz/blitz8.png', description: 'These are the 2 most important command grabs for Blitz and is what makes him a grappler. Both can combo into super in the corner, and in steam can combo into S2 super anywhere on screen for big damage.', video: 'videos/blitz/key-moves/blitz8.mp4' }, 
          { numericNotation: '2L and 2M', notation: '', notationImage: '/key-moves-notation/blitz/blitz9.png', description: 'Blitz has 2 lows, which are of vital importance to his mix, due to his weak block strings you will rely on these simple tools.', video: 'videos/blitz/key-moves/blitz9.mp4' },  
        ]
      },
      {
      ...
      },
      {
        ...
        teams: [
          ...
          },
          {
            ...
            explanation: 'A team all about using Vi to get in fast, and Blitz to either restand or trade out for oppressive corner pressure. The big damage is also nice',
            videos: [
              { id: 'DjdZgubxHJU' }
            ]
          },          
