export const ekko = {// Ekko Data Starts Here
    ...
    tabs: [
      ...
      },
      {
        ...
        combos: [
          { purpose: 'BnB (easy, roll optional for side swap)', numericNotation: 'M > H > S2 > S2 > S1 + L > 2H > 2S1 > j.[H] > 2S2 > H > 2T', notationImage: '/combo-notation/ekko/ekko-combo-5.png', video: 'videos/ekko/combos/ekko-combo-5.mp4' },
          ...
          { purpose: '2 bar mid screen', numericNotation: 'M > H > S2 > S2 > S1+L > 2H > 2S1 > j.[H] > [2S2] > S1+L > S2 > 2T', notationImage: '/combo-notation/ekko/ekko-combo-6.png', video: 'videos/ekko/combos/ekko-combo-6.mp4' },
          ...
          { purpose: 'Corner BnB', numericNotation: 'M > H > S2 > S2 > L > H > S2 > 2S2 > j.[S2] > L > M > H > 6S1 > 2S2 > 6S1 > S2+L', notationImage: '/combo-notation/ekko/ekko-combo-7.png', video: 'videos/ekko/combos/ekko-combo-7.mp4' },
          { purpose: 'Corner BnB into launcher', numericNotation: 'M > H > S2 > S2 > L > H > S2 > 2S2 > j.[S2] > L > M > H > S1+L > S2 > j.M > j.S2 > H > 2T', notationImage: '/combo-notation/ekko/ekko-combo-8.png', video: 'videos/ekko/combos/ekko-combo-8.mp4' },
          { purpose: 'Corner 2 bar combo', numericNotation: 'M > H > S2 > S2 > L > H > S2 > 2S2 > j.[S2] > L > M > H > S1+L > S2 > j.M > j.S2 > 6S1 (two hits only) > S1+L > 2S2 > 2T', notationImage: '/combo-notation/ekko/ekko-combo-9.png', video: 'videos/ekko/combos/ekko-combo-9.mp4' },
