  ...
  tabs: [
      {
        ...
        moves: [
          { numericNotation: '5M/2M', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi1.png', description: 'Illaoi\'s mediums are very good. 5M and 2M help you approach while maintaining pressure from a good distance', video: 'videos/illaoi/key-moves/illaoi1.mp4' },
          ...
          { numericNotation: 'S2 super', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi3.png', description: "Popping this super after a knockdown in the corner is one of the best spots to be in the game. Be patient, mind the timing that the tentacles strike and try to hit the enemy in the gaps between each round of tentacle strikes to keep the pressure tight.", video: 'videos/illaoi/key-moves/illaoi3.mp4' },
          { numericNotation: 'j.S2', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi4.png', description: "A powerful but fairly unsafe move. Try to use it to be unpredictable in the air and bait anti airs, or to cross to the other side of your opponent and hit them from behind. Calling an assist together with this moves make it go from powerful but unsafe to powerful and safe.", video: 'videos/illaoi/key-moves/illaoi4.mp4' },
          { numericNotation: 'S1 super', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi5.png', description: "S1 Super is Illaoi's best option to end a combo with the opponent on the ground midscreen, but doesn't synergize with Double Downs well. Can be used to reposition a tentacle under the opponent if the input is held.", video: 'videos/illaoi/key-moves/illaoi5.mp4' },   
          { numericNotation: '6S2', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi6.png', description: "This move is illaoi's only standing overhead attack. It has a charged version that's able to bait parries, but is fairly reactable. Use your assist to cover the startup or use it at unpredictable times in block string.", video: 'videos/illaoi/key-moves/illaoi6.mp4' },   
          { numericNotation: '4S1/1S1', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi7.png', description: "Illaoi's tentacles are integral to her set-play. These are the raw tentacle moves (motion/seize) and are amazing for oki pressure after S1 Super or j.S2. Also great for mix-ups in block pressure or when they're positioned behind the opponent.", video: 'videos/illaoi/key-moves/illaoi7.mp4' },   
          { numericNotation: '2S2', notation: '', notationImage: '/key-moves-notation/illaoi/illaoi8.png', description: "Her best poke tool, but can be low-parried. Use charged version to punish long-wind up zoners (Yasuo Windwall/Jinx Monkey)", video: 'videos/illaoi/key-moves/illaoi8.mp4' }   
        ],
      },
      {
