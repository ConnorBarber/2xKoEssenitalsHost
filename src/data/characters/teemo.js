  ...
  tabs: [
    {
      ...
      moves: [
        ...
        { numericNotation: '5M', notation: 'Teemo\'s fastest button with good range(8 frames + better range than 2L), and a combo starter', notationImage: '/key-moves-notation/teemo/teemo3.png', description: 'Teemo\'s fastest button with good range(8 frames + better range than 2L), and a combo starter	', video: 'videos/teemo/teemo3.mp4' },
        { numericNotation: '2M', notation: 'Forward advancing low, and combo starter(NOTE: First hit is mid and 2 follow ups are low)', notationImage: '/key-moves-notation/teemo/teemo4.png', description: 'Forward advancing low, and combo starter(NOTE: First hit is mid and 2 follow ups are low)', video: 'videos/teemo/teemo4.mp4' },
        { numericNotation: '2H', notation: 'Universal Anti Air', notationImage: '/key-moves-notation/teemo/teemo5.png', description: 'Universal Anti Air', video: 'videos/teemo/teemo5.mp4' },
        { numericNotation: 'j.L', notation: 'Diagonal poke tool, used for keepout, combos. and approach', notationImage: '/key-moves-notation/teemo/teemo6.png', description: 'Diagonal poke tool, used for keepoutl, combos. and approach ', video: 'videos/teemo/teemo6.mp4' },
        { numericNotation: 'S2 (j.S2)', notation: 'Shroom traps used to build mushroom meter, combo, camp/zoning keepout, and oki', notationImage: '/key-moves-notation/teemo/teemo7.png', description: 'Shroom traps used to build mushroom meter, combo, camp/zoning keepout, and oki	', video: 'videos/teemo/teemo7.mp4' },
        { numericNotation: 'j.M', notation: 'Multi-hitting jump normal. Very active and deceptively big hitbox beneath and very easy to confirm.', notationImage: '/key-moves-notation/teemo/teemo8.png', description: 'Multi-hitting jump normal. Very active and deceptively big hitbox beneath and very easy to confirm.', video: 'videos/teemo/teemo8.mp4' },
      ]
    },
    {
